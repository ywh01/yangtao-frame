package yangtao.love.common.tool.oss;

import com.aliyun.oss.OSS;
import com.aliyun.oss.OSSClientBuilder;
import com.aliyun.oss.OSSException;
import com.aliyun.oss.model.*;
import yangtao.love.common.tool.UuidUtils;
...
public class AliOSSUtil {
    ...
    public AliOSSUtil(AliOSSProperties aliOSSProperties) {
        ...
        ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret); // 创建 OSS 客户端实例
    }
